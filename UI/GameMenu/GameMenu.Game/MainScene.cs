...
namespace GameMenu
{
    public class MainScene : UISceneBase
    {
        ...
        public MainScene(GameMenuGame uiGame)
            : base(uiGame)
        {
            CreateScene();
        }
        ...
        {
            mainScreneImages = LoadAsset<UIImageGroup>(GameMenuGame.TextureDirectory + "MainSceneImages");
            westernFont = LoadAsset<SpriteFont>(GameMenuGame.FontDirectory + "WesternFont");
        ...
        private UniformGrid CreateShipButtonElement(SpaceShip spaceShip)
        {
            ...
            var statusTextGrid = new UniformGrid{ Rows = 3 };
        ...
        private UIElement CreateMainScene()
        {
            ...
            var explanationLabel = new ContentDecorator
            {
                ...
                Content = new TextBlock
                {
                    Font = LoadAsset<SpriteFont>(GameMenuGame.FontDirectory + "JapaneseFont"),
                    TextSize = 34,
                    TextColor = Color.White,
