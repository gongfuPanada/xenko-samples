...
namespace SimpleTerrain
{
    ...
    public class SimpleTerrainGame : Game
    {
        ...
        private bool RenderWireFrame
        {
            ...
            set
            {
                if (renderWireFrame == value) return;
                renderWireFrame = value;
                GraphicsDevice.Parameters.Set(Effect.RasterizerStateKey, value ? wireFrameRasterizerState : defaultRasterizerState);
            }
        }
        ...
        protected override void UnloadContent()
        {
            ...
            // todo: Issue a crash problem due to sprite font unloading
        ...
        private void CreateUI()
        {
            ...
            UI.RootElement = new Canvas { Children = { buttonDescription, loadingModal, loadingTextBlock } }; 
        }
        ...
        private void UpdateCamera()
        {
            ...
            cameraEntity.Transformation.Translation = Vector3.Transform(CameraStartPosition * zoomFactor, rotationQuat);
        }
        ...
        private async Task GenerateTerrain()
        {
            ...
            await Task.Run(() =>
            {
                ...
                terrainEntity.Transformation.Translation.Y = -(height + 100);
            });
